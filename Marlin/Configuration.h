...
#define STRING_CONFIG_H_AUTHOR "(Sebastian Barriera)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Spawn"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 8000, 244.84 }
